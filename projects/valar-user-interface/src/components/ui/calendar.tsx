...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "border-border bg-background-light p-3 text-white",
        className,
      )}
      classNames={{
        ...
        nav_button: cn(
          buttonVariants({ variant: "v_outline" }),
        ...
        day_selected:
          "bg-neutral-700 bg-opacity-50 text-neutral-50   hover:text-black dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
        day_today:
          "bg-background bg-opacity-50 border-border border  dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
