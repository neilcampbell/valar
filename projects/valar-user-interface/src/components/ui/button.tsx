  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-neutral-300",
  {
    variants: {
      ...
      variant: {
        ...
        v_primary:
          "bg-primary text-text text-base font-semibold leading-7 hover:bg-primary-light",
        v_secondary:
          "bg-secondary text-black text-base font-semibold leading-7 hover:bg-secondary-dark",
        v_tertiary:
          "bg-tertiary text-black text-base font-semibold leading-7 hover:bg-tertiary-light",
...
const IconButton: React.FC<React.ComponentProps<"div">> = ({
  children,
  ...props
}) => {
  return (
