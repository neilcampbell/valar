...
from smart_contracts.artifacts.validator_ad.client import ContractDeleteReturn
...
TEST_DELEGATOR_INITIAL_STATE = "ENDED_EXPIRED"
...
def test_action(
    ...
    del_bal_start = available_balance(
    ...
    assert res.return_value == ContractDeleteReturn(
        remaining_balance=del_bal_start,
        asset_id=gs_del_start.delegation_terms_general.fee_asset_id,
