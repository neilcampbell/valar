...
from algokit_utils.beta.composer import AssetFreezeParams
...
def test_action(
    ...
    validator_ad.algorand_client.send.asset_freeze(
        AssetFreezeParams(
    ...
    amount = 0 # Because the delegator contract account is frozen
    ...
    assert gs_del_new.state == dc.STATE_ENDED_CANNOT_PAY
