...
from smart_contracts.artifacts.validator_ad.client import EarningsDistributionAndMessage
...
def test_action(
    ...
    if asset == ALGO_ASA_ID:
        ...
        gs_exp.total_algo_earned = 0
        gs_exp.total_algo_fees_generated = 0
    ...
    assert gs_del_new.state == dc.STATE_ENDED_SUSPENDED
