...
from tests.utils import available_balance, calc_earnings, calc_operational_fee, get_box, is_expected_logic_error
...
def test_action(
    ...
    assert base64.b64decode(res.tx_info["inner-txns"][-1]["txn"]["txn"]["note"]) == MSG_CORE_CONTRACT_EXPIRED
    ...
    if asset == ALGO_ASA_ID:
        ...
        # assert bal_end_asset == bal_start_asset + platforms_earns # Redundant check
    ...
    gs_del_exp.state = dc.STATE_ENDED_EXPIRED
