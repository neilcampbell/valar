...
def get_smart_contract_create_info(path: "str") -> None:
    """
    ...
    PAGE_SIZE = 2048 # Number of bytes per program page  # noqa: N806
    extra_program_pages = total_size // PAGE_SIZE  # Integer division to get extra pages
    ...
    # in microAlgos
    COST_APP_PAGE = 100_000  # noqa: N806
    COST_STATE_ENTRY = 25_000  # noqa: N806
    COST_UINT = COST_STATE_ENTRY + 3_500  # noqa: N806
    COST_BYTES = COST_STATE_ENTRY + 25_000  # noqa: N806
    ...
    print()
    print("Total compiled program size in bytes: ", total_size)
    print()
...
pathDelegatorContract = "../artifacts/delegator_contract/DelegatorContract"  # noqa: N816

get_smart_contract_create_info(pathDelegatorContract)

# For ValidatorAd
print("----- Validator Ad -----")
pathValidatorAd = "../artifacts/validator_ad/ValidatorAd"  # noqa: N816

get_smart_contract_create_info(pathValidatorAd)

# For Noticeboard
print("----- Noticeboard -----")
pathNoticeboard = "../artifacts/noticeboard/Noticeboard"  # noqa: N816

get_smart_contract_create_info(pathNoticeboard)
